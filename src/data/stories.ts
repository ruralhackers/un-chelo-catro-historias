...
export const mainStories: Story[] = [
  {
    ...
    fullStory: 'Javier Merelas dedica a súa vida ao traballo artesanal co castaño galego. Nas súas mans, a madeira cobra vida e forma, mantendo viva unha tradición que se remonta a xeracións. O seu taller en Ourense é un lugar onde o tempo parece deténse, onde cada golpe de formón conta unha historia diferente. A súa madeira aporta ao chelo a fortaleza e a resistencia que caracterizan ao pobo galego.',
  ...
  },
  {
    ...
    image: 'https://images.pexels.com/photos/5691582/pexels-photo-5691582.jpeg'
  },
  {
    id: 'xaneco',
    name: 'Xaneco',
...
export const additionalStories: Story[] = [
  {
    ...
    fullStory: 'Cesar Arias ten unha relación especial co ciprés galego. Coñece cada anel da madeira, cada veta que conta os anos pasados. O seu traballo caracterízase pola precisión e o respecto absoluto polas propiedades naturais da madeira. O ciprés que achega proxecto ten a durabilidade e a resistencia ao tempo que simboliza a permanencia da cultura galega.',
    image: 'https://images.pexels.com/photos/5691615/pexels-photo-5691615.jpeg'
  },
  {
    id: 'roi-earan',
    name: 'Roi Earan',
    ...
    image: 'https://images.pexels.com/photos/5691614/pexels-photo-5691614.jpeg'
  },
  {
    id: 'inazio',
    name: 'Inazio',
    ...
    image: 'https://images.pexels.com/photos/5691617/pexels-photo-5691617.jpeg'
  }
];
